...
mysql_connect("localhost", "root", "")
 ...
 mysql_select_db("advtable") 
 or die(mysql_error()); 
 
 $data = mysql_query("SELECT * FROM horizontal") 
 or die(mysql_error()); ?>
                                        
										<?php
										while($info = mysql_fetch_array( $data )) {
											echo "<tr class='gradeA'>";
                                            echo "<td>".$info['rengine'] . " </td>";
                                            echo "<td>".$info['browser'] . " </td>";
                                            echo "<td>".$info['platform'] . " </td>";
                                            echo "<td>".$info['engvers'] . " </td>";
                                            echo "<td>".$info['cssgrade'] . " </td>";
											echo "</tr>";
										}
										?>
